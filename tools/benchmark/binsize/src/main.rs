...
// 1.: It takes a directory path, looks for wasm binaries in the directory
// (i.e., extension .wasm), notes the size in bytes of each, and writes the
// result in ndjson format to stdout. Likewise for benchmarking the gnuzip'd
// wasm binaries.
// 2.: It takes a path to a file and writes the file size in ndjson format
// to stdout.
